...
export const SKILL_NAME = "construct";
...
// them:
//
//   <payload>/scripts/construct.mjs  → <payload>/SKILL.md              (installed skill)
//   <repo>/scripts/construct.mjs     → <repo>/skills/construct/SKILL.md (repo-root bundle)
//   <repo>/src/mcp/resources.ts     → <repo>/skills/construct/SKILL.md (source tree, tests)
//
