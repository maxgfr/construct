...
import { extractPdf, enabledExtractors, resetPdfLadderCache } from "../src/research/pdf/ladder.js";
import { assessPdfText } from "../src/research/pdf/quality.js";
...
describe("enabledExtractors", () => {
  ...
  it("honours CONSTRUCT_PDF_ENGINE by running exactly that rung", () => {
    vi.stubEnv("CONSTRUCT_PDF_ENGINE", "native");
